...
HyperLogLog используют в Redis, BigQuery, ClickHouse, Presto. В этой статье мы разберем и реализуем этот алгоритм на C и Rust, а также узнаем его предысторию.

---


 > HyperLogLog использует идею, что вероятность увидеть n нулей подряд в конце хеша ≈ 1/2ⁿ⁺¹.
